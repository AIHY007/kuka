...
const avatarTones = {
  ...
  const CITY_PROVINCE = {
    ...
    "金华": "浙江省", "天津": "天津市", "保定": "河北省", "济南": "山东省",
    "山东": "山东省", "烟台": "山东省", "广州": "广东省", "福建": "福建省",
  ...
  const CITY_COORDS = {
    ...
    "天津": [117.20, 39.13], "保定": [115.46, 38.87], "济南": [117.00, 36.67],
    "山东": [118.05, 36.18], "烟台": [121.45, 37.46], "广州": [113.26, 23.13],
    "福建": [119.30, 26.07], "深圳": [114.06, 22.54], "宜昌": [111.29, 30.69],
    "武汉": [114.31, 30.52], "长沙": [112.94, 28.23], "其他": [113.26, 23.13],
    "抚州": [116.36, 27.95]
  };
